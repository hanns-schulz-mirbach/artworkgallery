...
$affectedRows = $exhibitionController->deleteExhibition();
...
<body>
	...
	<div id="workarea">
		...
		<article>
			<h1>Ergebnis Löschung Ausstellung</h1>
<?php
if ($affectedRows == 1) {
    echo ('Die Löschung der Ausstellung war erfolgreich.');
} else {
    echo ('Die Löschung der Ausstellung hat nicht funktioniert. Bitte überprüfen Sie die Daten und wiederholen Sie ggf. die   ');
    echo ('<a href="' . $updateUrl . '">Löschung der Ausstellung</a>');
}
echo ("<br /> <br />");
