...
$exhibition = $exhibitionController->getExhibitionById(intval($_GET["id"]));
...
$affectedRows = $exhibitionController->updateExhibition();

$updateUrl = "exhibition_update.php?id=" . $exhibition->getId();
...
<body>
	...
	<div id="workarea">
		...
		<article>
			<h1>Ergebnis Änderung Ausstellung</h1>
<?php
if ($affectedRows == 1) {
    echo ('Die Änderung der Ausstellung war erfolgreich. Es wurden die folgenden Daten übernommen: ');
    echo ("<br />");
    echo ("<br />");
    echo ($exhibition);
} else {
    echo ('Die Änderung des Ausstellung hat nicht funktioniert. Bitte überprüfen Sie die Daten und wiederholen Sie ggf. die   ');
    echo ('<a href="' . $updateUrl . '">Änderung des Ausstellung</a>');
}
echo ("<br /> <br />");
