...
$translation = $techniqueController->getTechnique()->getTranslation();
...
$affectedRows = $techniqueController->insertTechnique();
...
<body>
	...
	<div id="workarea">
		...
		<article>
			<h1>Ergebnis Neuanlage Technik</h1>
<?php
if ($affectedRows == 1) {
    echo ('Die Neuanlage der Technik war erfolgreich. Es wurden die folgenden Daten übernommen: ');
    echo ("<br />");
    echo ("<br />");
    echo ($techniqueController->getTechnique());
} else {
    echo ('Die Neuanlage der Technik hat nicht funktioniert. Bitte überprüfen Sie die Daten und wiederholen Sie ggf. die   ');
    echo ('<a href="technique_create.php">Neuanlage der Technik</a>');
}
echo ("<br /> <br />");
