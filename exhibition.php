...
$allExhibitionsGui = $exhibitionController->getAllExhibitionsGui($tc, $formatter);
...
echo ($tc->getEndUserTextforCurrentLanguageByCode("zzz-exhibition") .
         "<br/><br/>");
echo ('<div class="image-set">');
echo ($allExhibitionsGui);
echo ('</div> <br/><br/>');
