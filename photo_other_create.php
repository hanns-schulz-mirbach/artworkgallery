...
<body>
	...
	<div id="workarea">
		...
		<article>
			<h1>Neuanlage Foto ohne Bezug zu einem Kunstwerk</h1>
			<form action="photo_other_create_confirmation.php" method="post"
				...
				<br /> <br /> <label for="fileforupload">Fotodatei:</label><br /> <input
					type="file" name="fileforupload">
			<?php
