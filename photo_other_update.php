...
$photo = $photoController->getOtherPhotoById($photoId);

$uploadDate = $photo->getUploadDate()->format("d.m.Y");

$pathToExistingFile = "./image/" . $photo->getFilename();

$updateUrl = "photo_other_update_confirmation.php?id=" . "$photoId";
$deleteUrl = "photo_other_delete.php?id=" . "$photoId";
...
<body>
	...
	<div id="workarea">
		...
		<article>
			<h1>Änderung Foto ohne Bezug zu einem Kunstwerk</h1>
