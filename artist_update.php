...
$updateUrl = "artist_update_confirmation.php?id=" . "$artistId";
$deleteUrl = "artist_delete.php?id=" . "$artistId";
?>
<!doctype html>
<html lang="de">
<head>
				...
				<table>
					...
					<tr>
						...
						<td><input type="text" class="firstname" name="firstname"
							id="firstname" value="<?php echo ($artist->getFirstname());?>"
							required />
					...
					<tr>
						...
						<td><input type="text" class="lastname" name="lastname"
							id="lastname" value="<?php echo ($artist->getLastname());?>"
							required /></td>
					</tr>
					<tr>
