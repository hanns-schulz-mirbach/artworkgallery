...
$affectedRows = $reportController->deleteReport();
$updateUrl = "report_update.php?id=" . $report->getId();
...
<body>
	...
	<div id="workarea">
		...
		<article>
			<h1>Ergebnis Löschung Bericht</h1>
<?php
if ($affectedRows == 1) {
    echo ('Die Löschung des Berichts war erfolgreich.');
} else {
    echo ('Die Löschung des Berichts hat nicht funktioniert. Bitte überprüfen Sie die Daten und wiederholen Sie ggf. die   ');
    echo ('<a href="' . $updateUrl . '">Löschung des Berichts</a>');
}
echo ("<br /> <br />");
