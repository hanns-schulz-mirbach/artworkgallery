...
<body>
	...
	<div id="workarea">
		...
		<article>
			<h1>Neuanlage Technik</h1>
			<form action="technique_create_confirmation.php" method="post">
				<label for="code">Kennung:</label> <input type="text" class="code"
					name="code" id="code" required /> <br /> <br /> <label
					for="translation_de">Text Deutsch:</label><br />
