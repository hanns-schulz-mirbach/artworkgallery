...
$affectedRows = $artistController->insertArtist();
...
<body>
	...
	<div id="workarea">
		...
		<article>
			<h1>Ergebnis Neuanlage Künstlerdaten</h1>
<?php
if ($affectedRows == 1) {
    echo ('Die Neuanlage der Künstlerdaten war erfolgreich. Es wurden die folgenden Daten übernommen: ');
    echo ("<br />");
    echo ("<br />");
    echo ($artistController->getArtist());
} else {
    echo ('Die Neuanlage der Künstlerdaten hat nicht funktioniert. Bitte überprüfen Sie die Daten und wiederholen Sie ggf. die   ');
    echo ('<a href="artist_create.php">Neuanlage der Künstlerdaten</a>');
}
echo ("<br /> <br />");
