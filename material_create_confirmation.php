...
$translation = $materialController->getMaterial()->getTranslation();
...
$affectedRows = $materialController->insertMaterial();
...
<body>
	...
	<div id="workarea">
		...
		<article>
			<h1>Ergebnis Neuanlage Material</h1>
<?php
if ($affectedRows == 1) {
    echo ('Die Neuanlage des Materials war erfolgreich. Es wurden die folgenden Daten übernommen: ');
    echo ("<br />");
    echo ("<br />");
    echo ($materialController->getMaterial());
} else {
    echo ('Die Neuanlage des Materials hat nicht funktioniert. Bitte überprüfen Sie die Daten und wiederholen Sie ggf. die   ');
    echo ('<a href="material_create.php">Neuanlage des Materials</a>');
}
echo ("<br /> <br />");
