...
$photos = $photoController->getAllOtherPhotos();

$formatter = new Formatter();
$photosTable = $formatter->getAllOtherPhotosAsTable($photos);
...
<body>
	...
	<div id="workarea">
		...
		<article>
			<h1>Übersicht Fotos ohne Bezug zu einem Kunstwerk</h1>
			
			<?php
echo ("$photosTable");
echo ("<br /> <br />");
echo ('<a href="photo_other_create.php">Neuer Datensatz</a>');
echo ("<br /> <br />");
