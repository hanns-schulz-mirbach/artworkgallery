...
$techniquesTable = $formatter->getAllTechniquesAsTable($techniques);
...
<body>
	...
	<div id="workarea">
		...
		<article>
			<h1>Übersicht Techniken</h1>
			
			<?php
echo ("$techniquesTable");
echo ("<br /> <br />");
echo ('<a href="technique_create.php">Neuer Datensatz</a>');
echo ("<br /> <br />");
