...
$availabilitiesTable = $formatter->getAllAvailabilitiesAsTable($availabilities);
...
<body>
	...
	<div id="workarea">
		...
		<article>
			<h1>Übersicht Verfügbarkeiten</h1>
			
			<?php
echo ("$availabilitiesTable");
echo ("<br /> <br />");
echo ('<a href="availability_create.php">Neuer Datensatz</a>');
echo ("<br /> <br />");
