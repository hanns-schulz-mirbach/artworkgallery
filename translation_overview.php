...
$translationType->setTypeCode(intval($_GET["type"]));

$translations = $tc->getAllTranslationsByType($translationType);

$formatter = new Formatter();
$translationTable = $formatter->getAllTranslationsAsTable($translations);
...
<body>
	...
	<div id="workarea">
		...
		<article>
			<h1>Übersicht Übersetzungen</h1>
			
			<?php
echo ("$translationTable");
echo ("<br /> <br />");
echo ('<a href="translation_create.php">Neuer Datensatz</a>');
echo ("<br /> <br />");
