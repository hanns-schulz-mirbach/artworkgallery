...
$affectedRows = $reportController->insertReport();
...
<?php
if ($affectedRows == 1) {
    echo ('Die Neuanlage des Berichts war erfolgreich. Es wurden die folgenden Daten übernommen: ');
    echo ("<br />");
    echo ("<br />");
    echo ("$report");
} else {
    echo ('Die Neuanlage des Berichts hat nicht funktioniert. Bitte überprüfen Sie die Daten und wiederholen Sie ggf. die   ');
    echo ('<a href="report_create.php">Neuanlage des Berichts</a>');
}
echo ("<br /> <br />");
