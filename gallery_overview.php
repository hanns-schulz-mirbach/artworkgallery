...
$galleries = $galleryController->getAllGalleries();

$formatter = new Formatter();
$galleriesTable = $formatter->getAllGalleriesAsTable($galleries);
...
<body>
	...
	<div id="workarea">
		...
		<article>
			<h1>Übersicht Bildergalerien</h1>
			
			<?php
echo ($galleriesTable);
echo ("<br /> <br />");
echo ('<a href="gallery_create.php">Neuer Datensatz</a>');
echo ("<br /> <br />");
