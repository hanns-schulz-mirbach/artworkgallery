...
$affectedRows = $artworkController->updateArtwork();
$updateUrl = "artwork_update.php?id=" . $artwork->getId();
...
<body>
	...
	<div id="workarea">
		...
		<article>
			<h1>Ergebnis Änderung Kunstwerk</h1>
<?php
if ($affectedRows >= 1) {
    echo ('Die Änderung des Kunstwerks war erfolgreich. Es wurden die folgenden Daten übernommen: ');
    echo ("<br />");
    echo ("<br />");
    echo ($artwork);
} else {
    echo ('Die Änderung des Kunstwerks hat nicht funktioniert. Bitte überprüfen Sie die Daten und wiederholen Sie ggf. die   ');
    echo ('<a href="' . $updateUrl . '">Änderung des Kunstwerks</a>');
}
echo ("<br /> <br />");
