...
$translation = $availabilityController->getAvailability()->getTranslation();
...
$affectedRows = $availabilityController->insertAvailability();
...
<body>
	...
	<div id="workarea">
		...
		<article>
			<h1>Ergebnis Neuanlage Verfügbarkeit</h1>
<?php
if ($affectedRows == 1) {
    echo ('Die Neuanlage der Verfügbarkeit war erfolgreich. Es wurden die folgenden Daten übernommen: ');
    echo ("<br />");
    echo ("<br />");
    echo ($availabilityController->getAvailability());
} else {
    echo ('Die Neuanlage der Verfügbarkeit hat nicht funktioniert. Bitte überprüfen Sie die Daten und wiederholen Sie ggf. die   ');
    echo ('<a href="availability_create.php">Neuanlage der Verfügbarkeit</a>');
}
echo ("<br /> <br />");
